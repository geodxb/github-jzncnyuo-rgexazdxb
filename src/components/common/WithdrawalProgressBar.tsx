              ...
              {flags.length > 0 && (
                <div className="mt-4 space-y-2">
                  <h5 className="font-semibold text-gray-800 text-sm uppercase tracking-wide">
                    WITHDRAWAL FLAGS ({flags.filter(f => f.status === 'approved').length} APPROVED)
                  </h5>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-2 space-y-1">
                            <p className="text-xs text-gray-500 uppercase tracking-wide">
                              Requested by: {flag.requestedByName} ({flag.requestedByRole}) on {flag.requestedAt.toLocaleDateString()}
                            </p>
                            {flag.reviewedByName && (
                              <p className="text-xs text-gray-600 uppercase tracking-wide">
                                Approved by: {flag.reviewedByName} on {flag.reviewedAt?.toLocaleDateString()}
                              </p>
                            )}
                            {flag.reviewComment && (
                              <p className="text-xs text-gray-700 italic">
                                Governor comment: {flag.reviewComment}
                              </p>
                            )}
                          </div>
                        </div>
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500 mt-1 uppercase tracking-wide">
                            Requested by: {flag.requestedByName} on {flag.requestedAt.toLocaleDateString()}
                          </p>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="flex-1">
                          ...
                          {flag.reviewComment && (
                            <p className="text-xs text-gray-700 mt-1 italic">
                              Governor rejection reason: {flag.reviewComment}
                            </p>
                          )}
                          <p className="text-xs text-gray-500 mt-1 uppercase tracking-wide">
                            Rejected by: {flag.reviewedByName} on {flag.reviewedAt?.toLocaleDateString()}
                          </p>
                        </div>
                      </div>
                    </div>
