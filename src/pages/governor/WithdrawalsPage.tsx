...
import FlagRequestsSection from '../../components/governor/FlagRequestsSection';
                    ...
                    <tr key={request.id} className="border-b border-gray-200 hover:bg-gray-50">
                          ...
                          {bankInfo ? (
                            <div className="space-y-2">
                              ...
                              <p className="text-gray-500 uppercase tracking-wide">
                                ...
                                <WithdrawalFlagIndicator withdrawalId={request.id} />
                              </div>
                            </div>
                          ) : (
                      ...
                      <td className="px-6 py-4">
                        <div className="flex flex-col space-y-1">
                          {/* Flag withdrawal button */}
                          <button
                            onClick={() => {
                              setSelectedFlagWithdrawal(request);
                              setShowFlagModal(true);
                            }}
                            className="px-2 py-1 bg-yellow-600 text-white text-xs font-bold hover:bg-yellow-700 transition-colors uppercase tracking-wide border border-yellow-700"
                          >
